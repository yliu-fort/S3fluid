    ...
    private dispatchRK4(encoder: GPUCommandEncoder) {
        ...
        pStage.setBindGroup(0, this.device.createBindGroup({
            ...
            entries: [
                ...
                { binding: 2, resource: { buffer: this.buffers.tmpLM } } // Using tmpLM for z_temp
            ]
        }));
        ...
        // k2
        this.dispatchRHS(encoder, this.buffers.tmpLM, this.buffers.k2);
        ...
        // k3
        this.dispatchRHS(encoder, this.buffers.tmpLM, this.buffers.k3);
        ...
        // k4
        this.dispatchRHS(encoder, this.buffers.tmpLM, this.buffers.k4);
